...
export const MAP_AVATAR_IMAGE_PATH = 
  "/images/avatars/baby.jpg";
...
export const CHICAGO_IMAGE_PATH = 
"/images/towns/chicago.jpeg";
...
export const SAINT_ALPHONSUS_ACADEMY_IMAGE_PATH = 
  "/images/towns/aaca.jpg";

export const SEANS_HOUSE_X = 112;
export const SEANS_HOUSE_Y = 52;
export const SEANS_HOUSE_IMAGE_PATH = 
  "/images/towns/house.jpeg";

export const ROWAN_LABS_X = 152;
export const ROWAN_LABS_Y = 96;
export const ROWAN_LABS_IMAGE_PATH = 
  "/images/towns/rowanlabs.jpg";
