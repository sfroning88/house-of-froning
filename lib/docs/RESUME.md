...
**AI/ML Engineer @ Rowan [Seed Startup Investment Bank]** _Full Stack Development, RAG, Data Engineering_
Chicago IL _Jul 2025 to Present_
• Building sell-side diligence platform using React frontend, Fast API backends with RQ Redis for 25+ M&A professionals
• Architect document ingestion pipeline processing 2+ K files of 1.5+ GB per business into Postgres and pgvector stores
• Implement adaptive RAG with streaming, hybrid vector/FTS retrievals, reciprocal rank fusion, and cross-encoder rerank
...
**Project: Tiny AI/ML for Two-Tiered Volcanic Eruption Monitoring** _TinyML, PEFT/LoRA, Distillation, Quantization | [https://github.com/sfroning88/fiery-spirit](https://github.com/sfroning88/fiery-spirit)_
Chicago IL _Aug 2026 to Present_
• Detect volcanic unrest by cross-correlating inferences from satellite imagery with on-ground sensor readings
• Build and freeze dataset by streaming 850+ GB of InSAR satellite imagery and 3.5+ K Llaima spectrograms into R2
• Balance satellite imagery dataset by augmenting real interferograms with Okada synthetic fringes for rarity coverage
...
**Project: AI/ML Platform for Senior Housing Investment** _Feature Engineering, MLOps, Full Stack Development | [https://github.com/sfroning88/deep-focus](https://github.com/sfroning88/deep-focus)_
...
**Community Impact:** 14u Basketball coach for Alphonsus Academy, 17u Baseball coach for the Chicago Warriors

**BS Computer Engineering** _University of Notre Dame_
Minor in Engineering Finance and Strategy, Minor in Accounting
**GPA: 3.92**/4.00, Cum Laude
Dean’s List 5x (2023 \- 2025\)
Notre Dame IN _Graduated May 2025_
